...
Adds a JSON-driven form rendering system powered by React Hook Form and Zod validation. Define forms as typed schemas and render them in three view modes — classic, conversational, or multistep. The component map architecture makes it easy to add custom field types.

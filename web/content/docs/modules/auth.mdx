...
Adds Better Auth with email/password login, Google OAuth, route protection, and server-side session validation. Sessions are stored in the database via the Prisma adapter.

## Prerequisites

- [Prisma](/docs/modules/prisma) module (Better Auth stores sessions in the database)
